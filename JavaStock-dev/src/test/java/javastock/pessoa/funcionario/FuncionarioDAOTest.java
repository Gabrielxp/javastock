...
public class FuncionarioDAOTest {
    ...
    public void testeSalvar() {
        ...
        Funcionario f2 = new Funcionario("Gabriel", "232.233.231-23", "76.676.454", "gabriel@gmail.com", e2, 1, (float) 2000, (float) 40, "GERENTE", "Diurno", "qweasd");

        FuncionarioDAO.getInstancia().salvar(f1);
        FuncionarioDAO.getInstancia().salvar(f2);
    }
}