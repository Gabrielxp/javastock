...
public class FuncionarioDAOTest {
    ...
    public void testeSalvar() {
        ...
        Funcionario f1 = new Funcionario("José Lucas", "102.323.323-23", "23.434.343","jaodv@gmail.com", e1, (float) 4.000, (float) 20, "GERENTE", "Noturno", "1q2w3e", 1);

        Endereco e2 = new Endereco("Rua Palmital", 777, "Centro Sul", "Dois vizinhos", "PR", "85660-000");
        Funcionario f2 = new Funcionario("Gabriel", "232.233.231-23", "76.676.454", "gabriel@gmail.com", e2, (float) 2.000, (float) 40, "GERENTE", "Diurno", "qweasd", 2);
